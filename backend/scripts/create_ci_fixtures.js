 ...
 *   Row 2    : B2=invoiceNumber, D2=invoiceDate
 *   Rows 4-8 : PO summary — A=poNumber, B=shippedQty, C=cartons, D=weightKg, E=cbm
 *   Row 10   : SKU header row (ignored by parser)
 *   Rows 11+ : SKU line items — A=skuCode, B=description, C=qty, D=unitPrice, E=total_price, F=weightKg, G=cbm
 *
 ...
 * @param {Array[]}  poSummaryRows       [[poNumber, shippedQty, cartons, weightKg, cbm], ...]
 * @param {Array[]}  lineItems           [[skuCode, description, qty, unitPrice, weightKg, cbm], ...]
 */
...
const mdLines = [
    ...
    'All files live in `backend/database/seed-data/`. Invoice date for all fixtures: **2026-04-15**.',
    '',
    '---',
    '',
];
