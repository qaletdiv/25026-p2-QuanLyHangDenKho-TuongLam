...
const FreightModel = models.freights;
const { parseTemplate, generateTemplate } = require('./freightParserService');
const { generateFreightXlsx }             = require('./freightExportService');
...
/** GET /freights/:id/export  — generate xlsx and return fileUrl */
async function exportXlsx(req, res) {
    ...
    const fileUrl = generateFreightXlsx(record);
    res.json({ fileUrl });
}
