        ...
        <form onSubmit={handleSubmit} className="flex flex-col max-h-[90vh]">
          ...
          <div className="flex items-center justify-between p-4 border-b border-border bg-muted/30">
            <h2 className="text-lg font-semibold flex items-center gap-2">
              ...
              {initialData ? 'Edit Mainline Shipment' : 'Create New Mainline Shipment'}
            </h2>
          ...
          <div className="p-6 overflow-y-auto space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Select value={formData.status} onValueChange={(v) => updateField('status', v)}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    <SelectItem value="Booking Received">Booking Received</SelectItem>
                    <SelectItem value="Booking Approved">Booking Approved</SelectItem>
                    <SelectItem value="Docs Sent">Docs Sent</SelectItem>
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-bold uppercase text-muted-foreground">Tracking / Reference Number</Label>
          ...
          <div className="p-4 border-t border-border bg-muted/30 flex justify-end gap-3">
            ...
            <Button type="submit" disabled={isLoading} className="min-w-[120px] gap-2">
              {isLoading ? 'Saving...' : <><Save className="w-4 h-4" /> Save Shipment</>}
            </Button>
          </div>
        </form>
      </div>
