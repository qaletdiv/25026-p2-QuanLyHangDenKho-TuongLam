          ...
          {canEdit && (
            <>
              ...
              <span className="hidden shrink-0 items-center gap-1 group-hover:flex group-focus-within:flex"
                ...
                <Button size="sm" variant="ghost" className="h-6 px-1.5 text-xs" disabled={busy !== null || !(manualIr[key] || '').trim()} onClick={() => manualAdd(l.shipment_id, l.po_number)}>Change</Button>
              </span>
