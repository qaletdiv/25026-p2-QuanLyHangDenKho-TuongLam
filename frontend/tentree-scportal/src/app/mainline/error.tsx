...
// Error boundary for all /mainline/* routes — a failed RSC fetch or render
// shows a recoverable message instead of a blank page.

import { AlertTriangle, RotateCw } from 'lucide-react';
import { Button } from '@/components/ui/button';

export default function MainlineError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
